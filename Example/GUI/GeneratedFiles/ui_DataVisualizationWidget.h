...
public:
    ...
    void setupUi(QWidget *DataVisualizationWidget)
    {
        if (DataVisualizationWidget->objectName().isEmpty())
            DataVisualizationWidget->setObjectName(QStringLiteral("DataVisualizationWidget"));
        ...
        labelDataSize->setObjectName(QStringLiteral("labelDataSize"));
        ...
        labelNumberOfLabel->setObjectName(QStringLiteral("labelNumberOfLabel"));
        ...
        labelTestingSetSize->setObjectName(QStringLiteral("labelTestingSetSize"));
        ...
        labelTrainingSetSize->setObjectName(QStringLiteral("labelTrainingSetSize"));
